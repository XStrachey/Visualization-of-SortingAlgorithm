...
QT_MOC_LITERAL(1, 13, 11), // "viewResized"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "GraphicsView\0viewResized\0"
};
...
void GraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GraphicsView::viewResized)) {
                *result = 0;
                return;
            }
        }
